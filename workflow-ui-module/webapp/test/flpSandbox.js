		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#LoanManagementBPAworkflowuimodule-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"LoanManagementBPAworkflowuimodule-display": {
								"semanticObject": "LoanManagementBPAworkflowuimodule",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=LoanManagementBPA.workflowuimodule",
									"url": sap.ui.require.toUrl("LoanManagementBPA/workflowuimodule")
								}
							}
						}
					}
